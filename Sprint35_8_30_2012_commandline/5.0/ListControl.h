// $Header: /CAMCAD/4.3/ListControl.h 2     10/03/03 12:05p Kurt Van Ness $

#if !defined(__ListControl_h__)
#define __ListControl_h__
...
Description: Interfaces of the classes "CListControl" and "CListViewEx"
...
/*** Declaration of class "CListControl" **************************************/
class CListControl: public CListCtrl, public CListBase
{
   DECLARE_DYNCREATE(CListControl);

   public:
   CListControl() {m_pListCtrl = reinterpret_cast<CListCtrlHelper*>(this);}
