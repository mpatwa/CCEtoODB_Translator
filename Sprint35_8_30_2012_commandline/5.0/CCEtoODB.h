// $Header: /CAMCAD/4.6/CCEtoODB.h 59    5/24/07 11:09p Rick Faltersack $

// CCEtoODB.h : main header file for the CAMCAD application
//
...
private:
   ...
   //void ApplyDftSolution(CCEtoODBDoc *doc, FileStruct *dftSlnFile);
   //void AdjustFlippedPCBs(CCEtoODBDoc *doc, FileStruct *dftSlnFile);
...
// CCEtoODBApp:
//
class CCEtoODBApp : public CWinApp
{
public:
