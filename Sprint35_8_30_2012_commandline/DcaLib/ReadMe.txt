========================================================================
    STATIC LIBRARY : DcaLib Project Overview
========================================================================

AppWizard has created this DcaLib library project for you. 
This file contains a summary of what you will find in each of the files that
make up your DcaLib application.
...
StdAfx.h, StdAfx.cpp
    ...
    named DcaLib.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "DcaLib.rc" and a "DcaLib.h" that 
