 ...
 *****************************************************************************/
/*
 *	Module: $Id: lmclient.h,v 1.169 2002/07/03 20:46:23 sluu Exp $
 *
...
#define LM_BEHAVIOR_CURRENT	LM_BEHAVIOR_V8_2
...
#ifdef HARDWARE_SIGNING	/*	TODO	*/
	int (FAR *pfSign) lm_args((LM_CHAR_PTR pInput, int iInSize, int iKeySize,
					LM_CHAR_PTR pOutput, int iOutSize));
#endif
