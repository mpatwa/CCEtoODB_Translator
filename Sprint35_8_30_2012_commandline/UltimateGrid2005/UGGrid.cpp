// $Header: /CAMCAD/4.6/UltimateGrid2005/UGGrid.cpp 1     5/08/06 8:28p Kurt Van Ness $
...
void CUGGrid::OnLButtonDown(UINT nFlags, CPoint point)
{
	...
	m_ctrl->OnLClicked(col,row,1,nFlags,&rect,&point,processed);
...
void CUGGrid::OnLButtonUp(UINT nFlags, CPoint point)
{
	...
	m_ctrl->OnLClicked(col,row,0,nFlags,&rect,&point,processed);
...
void CUGGrid::OnLButtonDblClk(UINT nFlags, CPoint point)
{
	...
	m_ctrl->OnDClicked(col,row,nFlags,&rect,&point,processed);
}
...
void CUGGrid::OnRButtonDown(UINT nFlags, CPoint point)
{
	...
	m_ctrl->OnRClicked(col,row,1,nFlags,&rect,&point,processed);
...
void CUGGrid::OnRButtonUp(UINT nFlags, CPoint point)
{
	...
	m_ctrl->OnRClicked(col,row,0,nFlags,&rect,&point,processed);
