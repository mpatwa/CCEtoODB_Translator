// $Header: /CAMCAD/4.6/UltimateGrid2005/UGEdit.cpp 1     5/08/06 8:28p Kurt Van Ness $
...
void CUGEdit::OnSetFocus(CWnd* pOldWnd) 
{
	...
	CUGCellType* ct = m_ctrl->GetCellType(	m_ctrl->m_editCell.GetCellType() );
	...
	RECT rect;
	GetClientRect(&rect);
   GetDC()->FillSolidRect(&rect,RGB(255,255,255)); // Added 20071030 - knv
