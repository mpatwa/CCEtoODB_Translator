// $Header: /CAMCAD/4.6/UltimateGrid2005/UGCtrl.h 1     5/08/06 8:28p Kurt Van Ness $
...
public:
	...
	BOOL AttachGrid(CWnd * wnd, UINT ID, bool headingFontBold=true);  // RCF Added headingFontBold param
	...
	//mouse and key strokes - added 20071029 knv
	virtual void OnLClicked(int col,long row,int updn,UINT nFlags,RECT *rect,POINT *point,BOOL processed);
	virtual void OnRClicked(int col,long row,int updn,UINT nFlags,RECT *rect,POINT *point,BOOL processed);
	virtual void OnDClicked(int col,long row,UINT nFlags,RECT *rect,POINT *point,BOOL processed);
	virtual void OnTH_LClicked(int col,long row,int updn,UINT nFlags,RECT *rect,POINT *point,BOOL processed=0);
	virtual void OnTH_RClicked(int col,long row,int updn,UINT nFlags,RECT *rect,POINT *point,BOOL processed=0);
	virtual void OnTH_DClicked(int col,long row,UINT nFlags,RECT *rect,POINT *point,BOOL processed=0);
	virtual void OnSH_LClicked(int col,long row,int updn,UINT nFlags,RECT *rect,POINT *point,BOOL processed=0);
	virtual void OnSH_RClicked(int col,long row,int updn,UINT nFlags,RECT *rect,POINT *point,BOOL processed=0);
	virtual void OnSH_DClicked(int col,long row,UINT nFlags,RECT *rect,POINT *point,BOOL processed=0);
	...
	virtual int OnEditFinish(int col, long row,CWnd *edit,CString& string,BOOL cancelFlag); // added 20071028 - knv
