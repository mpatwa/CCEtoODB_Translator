// $Header: /CAMCAD/4.6/UltimateGrid2005/UGCelTyp.cpp 1     5/08/06 8:28p Kurt Van Ness $
...
/*	if(overLapCol != col)
	...
	if(cellTypeEx&(UGCT_NORMALMULTILINE|UGCT_NORMALELLIPSIS))
	{
		...
		{ // ellipsis
			...
			if (!m_useThemes || !DrawThemedText(*dc, left, top, &offsetRect, string, stringLen, DT_END_ELLIPSIS | DT_SINGLELINE, cell->GetXPStyle(), state))
			{
