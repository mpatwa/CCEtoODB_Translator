// $Header: /CAMCAD/4.6/UltimateGrid2005/ugxpthemes.h 1     5/08/06 8:28p Kurt Van Ness $
...
public:
	...
	static bool WriteText(HWND hwnd, HDC hdc, LPCWSTR theme, int partID, 
		int stateID, LPCSTR text, int textLength, DWORD textFlags, const RECT *pRect, bool useCache = true);
	...
	static bool WriteText(HWND hwnd, HDC hdc, UGXPCellType type, UGXPThemeState state,
		LPCWSTR text, int textLength, DWORD textFlags, const RECT *pRect);
	static bool WriteText(HWND hwnd, HDC hdc, UGXPCellType type, 
